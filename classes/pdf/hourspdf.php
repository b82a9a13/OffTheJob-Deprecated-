...
$user = $lib->get_username($userid)->username;
...
$pdf->Output("HoursLog-$username-$coursename.pdf");

\local_offthejob\event\viewed_hours_pdf::create(array('context' => $context, 'relateduserid' => $userid, 'courseid' => $courseid))->trigger();