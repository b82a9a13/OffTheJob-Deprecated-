...
class viewed_mar_pdf_learner extends base {
    protected function init(){
        $this->data['crud'] = 'r';
        $this->data['edulevel'] = self::LEVEL_PARTICIPATING;
    }
    public static function get_name(){
        return "Learner monthly activity pdf viewed";
    }
    ...
    public function get_url(){
        return new \moodle_url('/local/offthejob/classes/pdf/marpdf_learn_single.php?courseid='.$this->courseid.'&id='.$this->other);
    }
