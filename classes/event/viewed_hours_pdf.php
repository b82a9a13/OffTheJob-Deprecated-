...
class viewed_hours_pdf extends base {
    protected function init(){
        $this->data['crud'] = 'r';
        $this->data['edulevel'] = self::LEVEL_TEACHING;
    }
    public static function get_name(){
        return "Coach off the job hours pdf viewed";
    }
    ...
    public function get_url(){
        return new \moodle_url('/local/offthejob/classes/pdf/hourspdf.php?userid='.$this->relateduserid.'&courseid='.$this->courseid);
    }
