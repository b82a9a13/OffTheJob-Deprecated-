...
if (isset($_POST['submit'])){
    $array = [];
    $string = "Location: ../../otj_hours_learn.php?input=success";
    ...
    if(empty($date) && empty($activity) && empty($whatlink) && empty($impact) && empty($duration) && empty($initial)){
        $checkarray[6] = 1;
    }
    $type = '';
    ...
    header("Location: ../../otj_hours_learn.php?input=$type&courseid=$courseid");
